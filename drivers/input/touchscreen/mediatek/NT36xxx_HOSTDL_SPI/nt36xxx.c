...
static int32_t nvt_ts_probe(struct spi_device *client)
{
	...
	if (client->irq) {
		...
		ts->irq_enabled = true;
<<<<<<< HEAD:drivers/input/touchscreen/mediatek/NT36xxx_HOSTDL_SPI/nt36xxx.c
...
>>>>>>> b3c796328823 ([SQUAS] drivers: affine to IRQF_PERF_AFFINE):drivers/input/touchscreen/NT36672A/nt36xxx.c
		if (ret != 0) {
